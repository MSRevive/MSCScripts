...
class Deposit : CGameScript
{
	void deposit_item()
	{
		...
		string L_ITEM = /* TODO: $func */ $func("func_filter_items", L_PLAYER, L_ITEM);
		if (L_ITEM != "0")
		{
			string L_FREE_BANK = /* TODO: $func */ $func("func_get_free_bank", L_PLAYER, L_ITEM);
			if (L_FREE_BANK != "0")
			{
				...
				string L_ITEM_SCRIPTNAME_STRING = /* TODO: $func */ $func("func_make_string", L_ITEM);
				string L_NEW_BANK_CONTENTS = /* TODO: $func */ $func("func_stack_quantity", L_BANK_CONTENTS, L_ITEM_SCRIPTNAME_STRING);
				...
				{
					string L_NUM_STORING = /* TODO: $math(subtract) */ L_NUM_STORING;
				}
