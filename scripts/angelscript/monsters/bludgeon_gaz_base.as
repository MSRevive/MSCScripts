...
class BludgeonGazBase : CGameScript
{
	...
	BludgeonGazBase()
	{
		...
		const int GOLD_MAX_BAGS = 8;
		const string ANIM_TRICK = "idle2";
		const string ANIM_JUMP = "jump";
		const string ANIM_LEAP = "longjump";
		const string ANIM_THROW = "m_attack1";
		const string ANIM_THROW_HOLD = "m_attack1";
		const string ANIM_HAMMER = "m_attack2";
		const string ANIM_WARCRY = "warcry";
		ATTACK_MOVERANGE = 48;
		ATTACK_RANGE = 110;
		ATTACK_HITRANGE = 180;
		CAN_FLINCH = 1;
		const int LEAP_RANGE = 220;
		ATTACK_HITCHANCE = 80;
		const int STEP_SIZE_NORM = 48;
		const string FREQ_IDLE = Random(5, 10);
		const float FREQ_LEAP = 10.0;
		const string FREQ_THROW = Random(5, 20);
		const string FREQ_JUMP = Random(2, 5);
		const string FREQ_STOMP = Random(10, 20);
		const string FREQ_CHARGE = Random(10, 20);
		const string DMG_SWING = RandomInt(50, 100);
		const string DMG_STUN = RandomInt(25, 50);
		const string DOT_BURN = RandomInt(100, 200);
		const string DOT_POISON = RandomInt(25, 75);
		const string DMG_CHARGE = RandomInt(50, 75);
		const int DMG_THROW = 80;
		const float CHANCE_STUN = 0.1;
		const string SOUND_LEAP = "monsters/bludgeon/bludgeonattack2.wav";
		const string SOUND_WARCRY = "monsters/bludgeon/bludgeon_gaz_bat2.wav";
		const string SOUND_ALERT = "monsters/bludgeon/bludgeon_gaz_bat1.wav";
		const string SOUND_SWING_MISS = "zombie/claw_miss2.wav";
		const string SOUND_SWING_HIT = "zombie/claw_strike1.wav";
		const string SOUND_ATTACK1 = "monsters/bludgeon/bludgeon_gaz_atk1.wav";
		const string SOUND_ATTACK2 = "monsters/bludgeon/bludgeon_gaz_atk2.wav";
		const string SOUND_ATTACK3 = "monsters/bludgeon/bludgeon_gaz_atk3.wav";
		const string SOUND_THROW = "monsters/bludgeon/bludgeon_gaz_snort.wav";
		const string SOUND_DEATH = "monsters/bludgeon/bludgeon_gaz_death.wav";
		const string SOUND_IDLE1 = "monsters/bludgeon/bludgeon_gaz_ask.wav";
		const string SOUND_IDLE2 = "monsters/bludgeon/bludgeon_gaz_answer.wav";
		const string SOUND_STRUCK1 = "weapons/cbar_hitbod1.wav";
		const string SOUND_STRUCK2 = "weapons/cbar_hitbod2.wav";
		const string SOUND_PAIN = "monsters/bludgeon/bludgeon_gaz_pain.wav";
		const string SOUND_SPELL = "monsters/bludgeon/bludgeon_gaz_spell.wav";
		const string SOUND_SNORT = "monsters/bludgeon/bludgeon_gaz_snort.wav";
		const string SOUND_STEP1 = "gonarch/gon_step1.wav";
		const string SOUND_STEP2 = "gonarch/gon_step2.wav";
		const string SOUND_LAND = "garg/gar_step2.wav";
		const string SOUND_CHARGE_START = "monsters/bludgeon/bludgeon_gaz_snort.wav";
		const string SOUND_CHARGE_GO = "monsters/bludgeon/bludgeondeath2.wav";
		const string SOUND_BURN = "ambience/steamburst1.wav";
		Precache("magic/boom.wav");
		Precache("poison_cloud.spr");
		const string MONSTER_MODEL = "monsters/bludgeon_gaz.mdl";
	...
	void npc_targetsighted()
	{
		...
		{
			DID_WARCRY = 1;
			string WARCRY_TYPE = RandomInt(1, 2);
			if (WARCRY_TYPE == 1)
			{
