...
class ElfWarriorBase : CGameScript
{
	...
	int AM_ESCORT;
	string ANIM_ATTACK;
	string ANIM_ATTACK_1H;
	string ANIM_ATTACK_1H_READY;
	string ANIM_ATTACK_2H;
	string ANIM_ATTACK_GAXE;
	string ANIM_ATTACK_JAB;
	string ANIM_ATTACK_MA;
	string ANIM_AURA;
	string ANIM_BLOCK;
	string ANIM_DEATH;
	string ANIM_DEATH1;
	...
	string ANIM_GUARD_IDLE;
	string ANIM_HOLD_AURA;
	string ANIM_IDLE;
	string ANIM_IDLE_CAUTIOUS;
	string ANIM_IDLE_NORMAL;
	string ANIM_JUMP;
	string ANIM_KICK;
	string ANIM_LONG_JUMP;
	string ANIM_LOOK;
	string ANIM_MA_IDLE;
	string ANIM_MOVE_CAUTIOUS;
	string ANIM_MOVE_FAST;
	string ANIM_PARRY;
	string ANIM_RUN;
	string ANIM_SPELL_CUDDLE;
	string ANIM_SPELL_FIRE;
	...
	string ELF_MODEL;
	string FIRST_CYCLE;
	string FREEZE_AURA_CL_SCRIPT;
	float FREEZE_AURA_DURATION;
	int FREEZE_AURA_RADIUS;
	string FREEZE_TARGS;
	float FREQ_BLOCK;
	int FREQ_FREEZE_AURA;
	float FREQ_JUMP;
	float FREQ_KICK;
	float FREQ_LOOK;
	float FREQ_THROW;
	...
	string SOUND_ATTACK_CRY1;
	string SOUND_ATTACK_CRY2;
	string SOUND_ATTACK_CRY3;
	string SOUND_DEATH;
	string SOUND_DRAW;
	string SOUND_PAIN1;
	string SOUND_PAIN2;
	string SOUND_PAIN3;
	string SOUND_PAIN4;
	string SOUND_SHIELD1;
	string SOUND_SHIELD2;
	string SOUND_SHIELD3;
	...
	ElfWarriorBase()
	{
		...
		ANIM_MOVE_FAST = "run";
		ANIM_MOVE_CAUTIOUS = "run_squatwalk1_R";
		ANIM_IDLE_CAUTIOUS = "stand_squatwalk1_R";
		ANIM_IDLE_NORMAL = "deep_idle";
		ANIM_LOOK = "look_idle";
		ANIM_GUARD_IDLE = "stand";
		ANIM_DUCK_MOVE = "crawl";
		ANIM_DUCK_IDLE = "crouch_idle";
		ANIM_JUMP = "jump";
		ANIM_LONG_JUMP = "long_jump";
		ANIM_AURA = "prepare_fireball";
		...
		ANIM_DEATH7 = "gutshot";
		ANIM_ATTACK_1H = "swordswing1_R";
		ANIM_ATTACK_2H = "longsword_swipe_L";
		ANIM_ATTACK_JAB = "swordjab1_R";
		ANIM_ATTACK_1H_READY = "swordready1_R";
		ANIM_ATTACK_GAXE = "battleaxe_swing1_L";
		ANIM_SPELL_PREP = "prepare_fireball";
		ANIM_SPELL_CUDDLE = "aim_fireball_R";
		ANIM_SPELL_FIRE = "throw_fireball_R";
		ANIM_DRAW_SWORD = "swordready1_R";
		ANIM_MA_IDLE = "aim_fists";
		ANIM_ATTACK_MA = "aim_punch1";
		ANIM_KICK = "stance_normal_highkick_r1";
		ANIM_SWEEP = "stance_normal_lowkick_r1";
		ANIM_PARRY = "longsword_parry";
		ANIM_BLOCK = "aim_block1_L";
		ANIM_HOLD_AURA = "aim_sword1_R";
		ELF_MODEL = "npc/elf_f_warrior.mdl";
		ATTACK_MOVERANGE = 48;
		ATTACK_RANGE = 80;
		ATTACK_HITRANGE = 120;
		WALK_RANGE = 200;
		...
		FREQ_THROW = 6.0;
		KNIFE_TYPE = "poison";
		KNIFE_THROW_ITEM = "proj_k_knife";
		CAN_KICK = 0;
		FREQ_KICK = Random(10.0, 25.0);
		KICK_RANGE = 90;
		LEAP_AFTER_KICK = 0;
		CAN_JUMP = 1;
		FREQ_JUMP = 5.0;
		MAX_JUMP_RANGE = 600;
		CAN_FREEZE_AURA = 0;
		FREEZE_AURA_RADIUS = 128;
		FREEZE_AURA_DURATION = 10.0;
		FREEZE_AURA_CL_SCRIPT = "effects/sfx_ice_burst";
		FREQ_FREEZE_AURA = 25;
		WEAPON_AURA = 0;
		WAURA_TYPE = "lightning";
		WAURA_EFFECT_SCRIPT = "effects/dot_lightning";
		WAURA_RANGE = 128;
		WEAPON_AURA_CL_SCRIPT = "monsters/telf_warrior_laxe_cl";
		DMG_WAURA = 300;
		DOT_WAURA = 100;
		WAURA_DMG_TYPE = "lightning_effect";
		FREQ_WAURA = Random(20.0, 30.0);
		WAURA_DURATION = 5.0;
		SOUND_WAURA_START = "magic/bolt_end.wav";
		SOUND_WAURA_LOOP = "magic/bolt_loop.wav";
		CAN_BLOCK = 0;
		FREQ_BLOCK = Random(20.0, 30.0);
		BLOCK_DURATION = 5.0;
		SOUND_STRUCK1 = "weapons/cbar_hitbod1.wav";
		SOUND_STRUCK2 = "weapons/cbar_hitbod2.wav";
		SOUND_STRUCK3 = "weapons/cbar_hitbod3.wav";
		SOUND_SHIELD1 = "weapons/axemetal1.wav";
		SOUND_SHIELD2 = "weapons/axemetal2.wav";
		SOUND_SHIELD3 = "doors/doorstop5.wav";
		SOUND_ATTACK1 = "zombie/claw_miss1.wav";
		SOUND_ATTACK2 = "zombie/claw_miss2.wav";
		SOUND_ATTACK_CRY1 = "npc/elvenfemale/ElfF_Attack1.wav";
		SOUND_ATTACK_CRY2 = "npc/elvenfemale/ElfF_Attack2.wav";
		SOUND_ATTACK_CRY3 = "npc/elvenfemale/ElfF_Attack3.wav";
		SOUND_PAIN1 = "npc/elvenfemale/ElfF_Criticalhit.wav";
		SOUND_PAIN2 = "npc/elvenfemale/ElfF_Pain1.wav";
		SOUND_PAIN3 = "npc/elvenfemale/ElfF_Pain2.wav";
		SOUND_PAIN4 = "npc/elvenfemale/ElfF_Pain3.wav";
		SOUND_DEATH = "npc/elvenfemale/ElfF_Die.wav";
