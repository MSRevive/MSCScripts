...
class Spider : CGameScript
{
	...
	Spider()
	{
		...
		MOVE_RANGE = 32;
		ATTACK_RANGE = 80;
		const float ATTACK_DAMAGE_LOW = 2.0;
		const float ATTACK_DAMAGE_HIGH = 3.0;
		const float ATTACK_ACCURACY = 0.6;
		const int FIN_EXP = 12;
		...
		CAN_FLEE = 0;
		const string SPIDER_MODEL = "monsters/spider.mdl";
		...
		const string SOUND_LATCH_MNTR = SND_STRUCK1;
