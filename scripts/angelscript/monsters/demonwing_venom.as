...
class DemonwingVenom : CGameScript
{
	...
	DemonwingVenom()
	{
		...
		const string SPIT_PROJECTILE = "proj_poison_spit2";
		NPC_GIVE_EXP = 600;
		ATTACK_RANGE = 72;
		ATTACK_HITRANGE = 72;
		const int DMG_CLAW = 200;
		...
		const string SOUND_SPIT = "bullchicken/bc_attack2.wav";
		Precache(SOUND_DEATH);
		const string SOUND_CIELING_FIDGET = "monsters/demonwing/demonwing_slct.wav";
		const string MONSTER_NAME = "Demonwing";
		const int MONSTER_SKIN_IDX = 1;
		const int MONSTER_HP = 3000;
	}
