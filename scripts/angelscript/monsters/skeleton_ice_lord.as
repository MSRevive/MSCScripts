...
{
	string ALT_ATTACK;
	string ANIM_ALTTHROW;
	string ANIM_ATTACK;
	string ANIM_BASEIDLE;
	string ANIM_BASERUN;
	string ANIM_BASEWALK;
	string ANIM_DEAD;
	string ANIM_DEATH;
	string ANIM_FAKEDEATH;
	string ANIM_FLINCH;
	string ANIM_IDLE;
	string ANIM_RUN;
	string ANIM_SLASH;
	...
	string SOUND_DEATH;
	string SOUND_FAKEDEATH1;
	string SOUND_FAKEDEATH2;
	string SOUND_FALL;
	string SOUND_FINAL;
	string SOUND_FINAL1;
	string SOUND_FINAL2;
	...
	string SOUND_WHACK;
	float SPECATK_FREQ_CIRCLE;
	float SPECATK_FREQ_FREEZE;
	...
	string WAS_SNOWING;
	string XFX_SPRITE;
	string XLIGHTNING_SPRITE;
	string XSEAL_MODEL;
	string XSOUND_FADE;
	string XSOUND_HITWALL;
	string XSOUND_HOVERLOOP;
	string XSOUND_PULSE;
	...
	SkeletonIceLord()
	{
		...
		SOUND_INTRO1 = "npc/ice_queen_live_beating2.wav";
		SOUND_INTRO2 = "npc/ice_queen_put_that_on_ice2.wav";
		SOUND_STAGETWO1 = "npc/ice_queen_cant_pronounce_loreldians2.wav";
		SOUND_STAGETWO2 = "npc/ice_queen_game2.wav";
		SOUND_FINAL1 = "npc/ice_queen_powah2.wav";
		SOUND_FINAL2 = "npc/ice_queen_die2.wav";
		...
		SOUND_FLINCH1 = "npc/ice_queen_pain2.wav";
		SOUND_FLINCH2 = "garg/gar_pain2.wav";
		SOUND_PUSH1 = "npc/ice_queen_throw2.wav";
		SOUND_PUSH2 = "npc/ice_queen_throw3.wav";
		...
		SOUND_FAKEDEATH1 = "garg/gar_die2.wav";
		SOUND_FAKEDEATH2 = "garg/gar_die1.wav";
		SOUND_DEATH = "npc/undamael2.wav";
		SOUND_FINAL = "gonarch/gon_die1.wav";
		SOUND_WHACK = "zombie/claw_strike1.wav";
		SOUND_REGEN = "x/x_laugh2.wav";
		SOUND_POWERUP = "ambience/particle_suck2.wav";
		ANIM_FAKEDEATH = "dieforward";
		ANIM_DEATH = "dieforward";
		ANIM_DEAD = "dead_on_stomach";
		ANIM_ALTTHROW = "bigflinch";
		ANIM_FLINCH = "flinch";
		TAUNT_DELAY = 2.0;
		GETUP_DELAY = 8.0;
		SPECATK_FREQ_CIRCLE = 20.0;
		SPECATK_FREQ_FREEZE = 20.0;
		STUCK_CHECK_FREQUENCY = 3.5;
		MONSTER_WIDTH = 40;
		FEIGN_THRESHOLD = 500;
		DAMAGE_NORM1 = Random(40.0, 55.0);
		DAMAGE_NORM2 = Random(30.0, 40.0);
		DAMAGE_BALL1 = Random(50.0, 55.0);
		DAMAGE_BALL2 = Random(60.0, 80.0);
		DAMAGE_CLUBS1 = Random(60.0, 85.0);
		DAMAGE_CLUBS2 = 200;
		CIRCLE_SCRIPT = "monsters/summon/circle_of_ice_greater";
		XSEAL_MODEL = "weapons/magic/seals.mdl";
		SOUND_MANIFEST = "magic/spawn_loud.wav";
		XSOUND_PULSE = "magic/frost_forward.wav";
		XSOUND_FADE = "magic/frost_reverse.wav";
		XSEAL_MODEL = "weapons/magic/seal_fire_large.mdl";
		XFX_SPRITE = "firemagic.spr";
		...
		XSOUND_HOVERLOOP = "ambience/alienwind1.wav";
		XSOUND_HITWALL = "ambience/alienlaser1.wav";
		XLIGHTNING_SPRITE = "lgtning.spr";
	...
	void throw_chummer()
	{
		...
		float NME_DIST = Distance(MY_NME_POS, MY_ME_POS);
