...
class SkeletonGstone1 : CGameScript
{
	...
	SkeletonGstone1()
	{
		...
		ANIM_RUN = "run";
		const int SKEL_HP = 4000;
		const float ATTACK_HITCHANCE = 0.85;
		const int ATTACK_DAMAGE_LOW = 26;
		...
		const string SOUND_RUN1 = "monsters/troll/step1.wav";
		const string SOUND_RUN2 = "monsters/troll/step2.wav";
