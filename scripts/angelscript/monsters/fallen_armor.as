...
class FallenArmor : CGameScript
{
	...
	FallenArmor()
	{
		...
		const string ANIM_WALK_SHIELD = "shield_walk";
		const string ANIM_STANCE_IDLE = "idle";
		const string ANIM_SIT_IDLE = "sit_idle";
		const string ANIM_SHIELD_IDLE = "shield_idle";
		ANIM_IDLE = ANIM_SIT_IDLE;
		ANIM_WALK = ANIM_WALK_NORM;
		ANIM_RUN = ANIM_RUN_NORM;
		ANIM_DEATH = "dead";
		const string ANIM_ATTACK_NORM = "attack1";
		const string ANIM_ATTACK_STAB = "attack2";
		const string ANIM_ATTACK_SHIELD = "shield_attack";
		ANIM_ATTACK = ANIM_ATTACK_NORM;
		const string ANIM_SUMMON = "summon";
		const string ANIM_GETUP = "get_up";
		const string ANIM_EQUIP = "equip";
		const string ANIM_EQUIP2 = "equip2";
		const string ANIM_TOSHIELD = "stance_to_shield";
		const string ANIM_TOSTANCE = "shield_to_stance";
		CAN_FLINCH = 0;
		CAN_FLEE = 0;
		const int SHIELD_RANGE = 500;
		const int TRIGGER_RANGE = 256;
		const int ATTACK_MOVERANGE_NORM = 28;
		const int ATTACK_MOVERANGE_SHIELD = 64;
		const int ATTACK_HITRANGE_SHIELD = 160;
		const int ATTACK_HITRANGE_STAB = 160;
		const int ATTACK_HITRANGE_NORM = 128;
		const int ATTACK_RANGE_NORM = 80;
		ATTACK_MOVERANGE = ATTACK_MOVERANGE_NORM;
		ATTACK_RANGE = 80;
		ATTACK_HITRANGE = ATTACK_HITRANGE_NORM;
		const int STAB_DAMAGE = 2200;
		const string SWORD_DAMAGE = "$rand(60,120)";
		const string SHIELD_DAMAGE = "$rand(50,200)";
		const float ACCURACY_SWORD = 0.8;
		const float ACCURACY_SHIELD = 0.9;
		const float ACCURACY_STAB = 1.0;
		const string STAB_FREQ = "$randf(30,60)";
		const string SOUND_GETUP = "amb/screeching.wav";
		const string SOUND_STEP1 = "player/pl_grate1.wav";
		const string SOUND_STEP2 = "player/pl_grate2.wav";
		const string SOUND_STEP3 = "player/pl_grate3.wav";
		const string SOUND_STEP4 = "player/pl_grate4.wav";
		MONSTER_STEP = 0;
		const string SOUND_STRUCK1 = "debris/metal1.wav";
		const string SOUND_STRUCK2 = "debris/metal3.wav";
		const string SOUND_STRUCKSHIELD1 = "debris/metal6.wav";
		const string SOUND_STRUCKSHIELD2 = "doors/doorstop5.wav";
		const string SOUND_HIT1 = "zombie/claw_strike1.wav";
		const string SOUND_HIT2 = "zombie/claw_strike3.wav";
		const string SOUND_LARGESWING = "zombie/claw_miss2.wav";
		const string SOUND_MISS1 = "weapons/swingsmall.wav";
		const string SOUND_MISS2 = "weapons/cbar_miss1.wav";
		const string SOUND_PAIN1 = "x/x_pain1.wav";
		const string SOUND_PAIN2 = "x/x_pain3.wav";
		const string SOUND_SUMMON = "x/x_ballattack1.wav";
		const string SOUND_SUMMON_START = "x/x_recharge2.wav";
		const string SOUND_POWERUP = "ambience/particle_suck2.wav";
		const string SOUND_PRE_STAB = "x/x_attack2.wav";
		const string SOUND_DEATH = "tentacle/te_death2.wav";
