...
class VgoblinGuard : CGameScript
{
	string ANIM_ATTACK;
	...
	void swing_axe()
	{
		...
		EmitSound(GetOwner(), 0, sounds[RandomInt(0, sounds.length() - 1)], 10);
		XDoDamage(m_hAttackTarget, ATTACK_HITRANGE, DMG_AXE, ATTACK_HITCHANCE, GetOwner(), GetOwner(), "none", "slash", "dmgevent:swing");
	}

	void swing_dodamage()
	{
		ApplyEffect(m_hAttackTarget, "effects/dot_poison", 10.0, GetEntityIndex(GetOwner()), DOT_FIRE);
	}
