...
class SlimeGreenHuge : CGameScript
{
	string ANIM_ATTACK;
	string ANIM_DEATH;
	string ANIM_IDLE;
	...
	void OnHuntTarget(CBaseEntity@ target)
	{
		...
		TossProjectile("proj_poison_spit2", /* TODO: $relpos */ $relpos(0, 0, -20), SPIT_TARGET, 300, SPIT_DAMAGE, 0.1, "none");
	}
