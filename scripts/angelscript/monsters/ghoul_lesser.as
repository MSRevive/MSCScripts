...
class GhoulLesser : CGameScript
{
	...
	GhoulLesser()
	{
		...
		const string SOUND_ALERT = "houndeye/he_alert1.wav";
		...
		const string SOUND_DEATH = "zombie/zo_attack2.wav";
		const string SOUND_STRUCK = "debris/flesh2.wav";
		const string SOUND_PAIN1 = "zombie/zo_pain2.wav";
		const string SOUND_PAIN2 = "houndeye/he_pain4.wav";
		...
		const string SOUND_HOLYPAIN1 = "zombie/zo_attack1.wav";
		const string SOUND_HOLYPAIN2 = "zombie/zo_attack2.wav";
		...
		MONSTER_WIDTH = 32;
		const float STUCK_CHECK_FREQUENCY = 2.1;
		Precache(SOUND_DEATH);
		Precache("monsters/ghoul_lesser.mdl");
		if (!(DID_ALERT))
		{
		}
		1_0();
	...
	void attack2()
	{
		STUCK_COUNT = 0;
		ATTACK_VOLUME = 10;
		DoDamage(ENTITY_ENEMY, ATTACK_HITRANGE, ATTACK2_DAMAGE, ATTACK2_ACCURACY, "slash");
