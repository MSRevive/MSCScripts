...
class VgoblinArcher : CGameScript
{
	string ANIM_ATTACK;
	int ATTACK_HITRANGE;
	int ATTACK_RANGE;
	...
	VgoblinArcher()
	{
		...
		const string ARROW_SCRIPT = "proj_arrow_gpoison";
	...
	void shoot_arrow()
	{
		...
		TossProjectile(ARROW_SCRIPT, /* TODO: $relpos */ $relpos(0, 0, 5), "none", 900, DMG_BOW, 2, "none");
