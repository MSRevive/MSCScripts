...
class KHollowOne : CGameScript
{
	...
	float FREQ_FLIGHT;
	float FREQ_MIRROR;
	float FREQ_SOUND_FLIGHT_LOOP;
	int ICE_DIST;
	string ICE_LIST;
	int IS_UNHOLY;
	int LHAND_ATCH;
	int MAX_DRAIN_SPRITES;
	int MIRRORS_ON;
	string MIRROR_ANG;
	float MIRROR_DURATION;
	int MOUTH_ATCH;
	int MP_DRAIN_RATE;
	string NEXT_BURN;
	string NEXT_DODGE;
	...
	string SOUND_DEATH;
	string SOUND_DODGE;
	string SOUND_FIREBALL_RELEASE;
	string SOUND_FIRE_PREP;
	string SOUND_FLIGHT_LOOP;
	string SOUND_FLIGHT_START;
	string SOUND_ICE_PREP;
	string SOUND_MIRROR_OFF;
	string SOUND_POISON_BREATH;
	string SOUND_POISON_BREATH_START;
	string SOUND_POP;
	string SOUND_SPELL_PREP;
	...
	KHollowOne()
	{
		...
		FLIGHT_SPEED = 100;
		MAX_DRAIN_SPRITES = 8;
		DRAIN_SPRITE_SPEED = 25;
		DRAINER_MAX_LIVE_TIME = 180.0;
		MP_DRAIN_RATE = -10;
		DMG_FIREBALL = 300;
		DMG_ICEBALL = 200;
		DOT_ICE = 50;
		...
		NPC_RANGED = 1;
		SOUND_SPELL_PREP = "magic/bolt_start.wav";
		SOUND_FIRE_PREP = "magic/spookie1.wav";
		SOUND_ICE_PREP = "magic/spookie1.wav";
		SOUND_POP = "magic/elecidlepop.wav";
		SOUND_FIREBALL_RELEASE = "ambience/alienflyby1.wav";
		sOUND_MIRROR = "monsters/gonome/gonome_melee2.wav";
		SOUND_MIRROR_OFF = "debris/beamstart15.wav";
		SOUND_BREATH = "monsters/goblin/sps_fogfire.wav";
		SOUND_ZAP_LOOP = "magic/bolt_loop.wav";
		SOUND_ZAP_START = "magic/bolt_end.wav";
		SOUND_POISON_BREATH = "magic/flame_loop.wav";
		SOUND_POISON_BREATH_START = "magic/flame_loop_start.wav";
		SOUND_DODGE = "magic/frost_reverse.wav";
		SOUND_FLIGHT_START = "magic/vent3.wav";
		SOUND_FLIGHT_LOOP = "magic/vent3.wav";
		FREQ_SOUND_FLIGHT_LOOP = 5.92;
		SOUND_DEATH = "x/x_pain3.wav";
