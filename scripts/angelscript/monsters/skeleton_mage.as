...
class SkeletonMage : CGameScript
{
	...
	SkeletonMage()
	{
		...
		const string ANIM_PROJECTILE = "anim_projectile";
		const string ANIM_SWIPE = "attack1";
		const string ANIM_SLAM = "attack2";
		const string ANIM_SEAL = "anim_seal";
		const string ANIM_KICK = "anim_roundhouse";
		const string ANIM_DEATH_IDLE = "dead_on_stomach";
		ANIM_RANGED_ATTACK = "anim_projectile";
		const int DMG_CLAW = 50;
		const int DMG_SLAM = 100;
		const int DMG_KICK = 100;
		const int DMG_SEAL = 400;
		...
		DROP_GOLD = 1;
		const int SKELE_GOLD = 500;
		AM_SKELETON = 1;
		const int SKELE_HEARING = 10;
		const float FREQ_KICK = 30.0;
		const int ATTACK_MELERANGE = 96;
		const int RANGE_PROJECTILE = 1024;
		const int RANGE_SEAL = 640;
		const int RANGE_SWIPE = 64;
		const int SEAL_RAD = 140;
		CUST_ELEMENT_LIST = "";
		const float FREQ_CL_UPDATE = 20.0;
		...
		const float BPAIN_PAIN_HEALTH = 1.0;
		...
		const string SOUND_PAIN1 = "monsters/undeadz/c_shadow_hit1.wav";
		const string SOUND_PAIN2 = "monsters/undeadz/c_shadow_hit2.wav";
		const string SOUND_DEATH = "monsters/undeadz/c_skeltwiz_bat1.wav";
		const string SOUND_CLAW_MISS = "zombie/claw_miss1.wav";
		const string SOUND_CLAW_HIT = "zombie/claw_strike1.wav";
	}
	...
	void cycle_up()
	{
		string L_TIME_SINCE_LAST_UPDATE = GetGameTime();
