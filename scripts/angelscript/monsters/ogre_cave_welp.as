...
class OgreCaveWelp : CGameScript
{
	...
	OgreCaveWelp()
	{
		...
		SOUND_IDLE1 = "monsters/ogre_welp/bc_idle1.wav";
		SOUND_IDLE2 = "monsters/ogre_welp/bc_idle2.wav";
		SOUND_IDLE3 = "monsters/ogre_welp/bc_idle3.wav";
		SOUND_IDLE4 = "monsters/ogre_welp/bc_idle4.wav";
		SOUND_IDLE5 = "monsters/ogre_welp/bc_idle5.wav";
		SOUND_DEATH = "monsters/ogre_welp/bc_die1.wav";
		SOUND_HEADBUTT = "monsters/ogre_welp/bc_spithit1.wav";
		...
		SOUND_PAIN_WEAK = "monsters/ogre_welp/bc_pain2.wav";
		SOUND_PAIN_STRONG = "monsters/ogre_welp/bc_pain1.wav";
		SOUND_WARCRY = "monsters/ogre_welp/bc_attackgrowl3.wav";
		SOUND_LEAP = "monsters/ogre_welp/bc_attackgrowl2.wav";
		SOUND_LEAP_LAND = "weapons/g_bounce2.wav";
		SOUND_FLINCH = "monsters/ogre_welp/bc_pain3.wav";
		Precache(SOUND_DEATH);
		SWIPE_DAMAGE = "$rand(30,65)";
		HEADBUTT_CHANCE = 1.0;
		HEADBUTT_FREQ = 7.0;
		HEADBUTT_DAMAGE = "$rand(30,65)";
		LEAP_DAMAGE = "$rand(10,20)";
		LEAP_STUNCHANCE = 0.3;
		LEAP_RANGE_TOOFAR = 512;
		LEAP_RANGE_TOOCLOSE = 128;
		LEAP_AWAY_INTERVAL = 500;
		FREQ_LEAP_AWAY = Random(10.0, 20.0);
		DROP_GOLD = 1;
		DROP_GOLD_MIN = 30;
		DROP_GOLD_MAX = 50;
