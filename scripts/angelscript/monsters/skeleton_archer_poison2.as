...
class SkeletonArcherPoison2 : CGameScript
{
	...
	SkeletonArcherPoison2()
	{
		...
		const string ARROW_CL_SCRIPT = "effects/sfx_poison_burst";
		const int DMG_AOE = 150;
	}
