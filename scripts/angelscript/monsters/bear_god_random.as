...
class BearGodRandom : CGameScript
{
	...
	BearGodRandom()
	{
		...
		ANIM_RUN = "run";
		ANIM_ATTACK = "attack";
		ATTACK_STOMPRANGE = 512;
		FREQ_STOMP = 20.0;
		FREQ_STAND = "$randf(15,25)";
		FREQ_BOLT = "$randf(10,20)";
		FREQ_TREE = "$randf(20,30)";
		DMG_STORM = 20.0;
		STORM_DUR = 60.0;
		STORM_RAD = 1024;
		SMASH_DAMAGE = "$rand(50,150)";
		...
		GOLD_RADIUS = 200;
		GOLD_MAX_BAGS = 32;
		SOUND_ATTACK1 = "monsters/bear/giantbearattack.wav";
		SOUND_STRUCK4 = "monsters/bear/giantbearpain.wav";
		SOUND_STRUCK5 = "none";
	...
	void pick_player_inrange()
	{
		...
		int RND_TARGET = RandomInt(1, N_TARGETS);
		RND_TARGET -= 1;
