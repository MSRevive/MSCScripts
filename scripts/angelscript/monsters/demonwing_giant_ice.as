...
class DemonwingGiantIce : CGameScript
{
	...
	DemonwingGiantIce()
	{
		...
		const string ANIM_CEILING_LAND = "Land_ceiling";
		const string ANIM_CEILING_DETATCH = "ceiling_detatch";
		const string ANIM_CEILING_IDLE1 = "Subtle_fidget";
		const string ANIM_CEILING_IDLE2 = "Preen_fidget";
		const string ANIM_CEILING_IDLE3 = "Swing_fidget";
		const string ANIM_FLY = "Flying_cycler";
		const string ANIM_HOVER = "Hover_slow";
		const string ANIM_BOOST = "Dive_cycler";
		ANIM_IDLE = "Hover_slow";
		const float FREQ_SPIT_CYCLE = 30.0;
		ANIM_DEATH = "Death_fall_simple";
		const string ANIM_DEATH_FLY_MODE = "Death_fall_simple";
		const string ANIM_DEATH_GROUND_MODE = "Die_on_ground";
		const string ANIM_FLINCH1 = "Flinch_big";
		const string ANIM_FLINCH2 = "Flinch_small";
		const int AS_CUSTOM_UNSTUCK = 1;
		const string ATTACK_BOMB = "Attack_bomb";
		const string ANIM_DIVE = "Dive_cycler";
		ICELANCE_DOT = 25;
		const int BREATH_FREEZE = 1;
		const string SPIT_PROJECTILE = "proj_icelance";
		const string BREATH_CL_SCRIPT = "monsters/demonwing_giant_ice_cl";
		const int NPC_EXTRA_VALIDATIONS = 1;
		const int NPC_VALIDATE_HEARING = 1;
		const int NO_BOMB = 1;
		...
		ATTACK_RANGE = 90;
		ATTACK_HITRANGE = 180;
		const int DMG_CLAW = 150;
		const int DOT_DMG = 30;
		const string FREQ_HORROR_BOOST = Random(3.0, 6.0);
		const int DMG_SPIT = 75;
		const int DMG_BOMB = 300;
		const float FREQ_SWITCH_GROUND_MODE = 60.0;
		const string SOUND_FLAP1 = "monsters/bat/flap_big1.wav";
		const string SOUND_FLAP2 = "monsters/bat/flap_big2.wav";
		const string SOUND_HOVER = "monsters/bat/flap_big.wav";
		const string SOUND_ATTACK1 = "monsters/demonwing/demonwing_atk1.wav";
		const string SOUND_ATTACK2 = "monsters/demonwing/demonwing_atk2.wav";
		const string SOUND_ATTACK3 = "monsters/demonwing/demonwing_atk3.wav";
		const string SOUND_ALERT1 = "monsters/demonwing/demonwing_bat1.wav";
		const string SOUND_ALERT2 = "monsters/demonwing/demonwing_bat2.wav";
		const string SOUND_ALERT1 = "monsters/demonwing/demonwing_bat1.wav";
		const string SOUND_STRUCK1 = "weapons/cbar_hitbod1.wav";
		const string SOUND_STRUCK2 = "weapons/cbar_hitbod2.wav";
		const string SOUND_STRUCK3 = "weapons/cbar_hitbod3.wav";
		const string SOUND_PAIN1 = "monsters/demonwing/demonwing_hit1.wav";
		const string SOUND_PAIN2 = "monsters/demonwing/demonwing_hit2.wav";
		const string SOUND_DEATH = "monsters/demonwing/demonwing_dead.wav";
		const string SOUND_SPIT = "magic/ice_strike2.wav";
		Precache(SOUND_DEATH);
		const string SOUND_CIELING_FIDGET = "monsters/demonwing/demonwing_slct.wav";
		const float FREQ_BOMB = 10.0;
		const float FREQ_BOMB_CHECK = 1.0;
		const string SOUND_FIRE_BREATH = "magic/cold_breath.wav";
		NO_CIELING_IDLE = 1;
		NPC_HACKED_MOVE_SPEED = 400;
		const string BABY_SCRIPT = "monsters/demonwing_ice";
	}
