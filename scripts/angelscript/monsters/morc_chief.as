...
class MorcChief : CGameScript
{
	...
	MorcChief()
	{
		...
		ATTACK_DMG_LOW = 400;
		ATTACK_DMG_HIGH = 800;
		ATTACK_SPECRANGE = 160;
		SOUND_SWAT = "monsters/orc/battlecry.wav";
		SOUND_KICK = "monsters/orc/attack3.wav";
		...
		SOUND_SWIPEMISS = "zombie/claw_miss2.wav";
