...
class MaldoraMinionRandom : CGameScript
{
	int AM_RISING;
	string ANIM_RUN;
	int ATTRIBS_SET;
	...
	void skeleton_spawn()
	{
		...
		SetName("Maldora's Minion NAME_SUFFIX");
		SetWidth(32);
		SetHeight(80);
		SetRace("undead");
		SetBloodType("none");
	...
	void skele_swing_dodamage()
	{
		...
		ApplyEffect(GetEntityIndex(param2), MINION_EFFECT, 5.0, GetEntityIndex(GetOwner()), RandomInt(10, 20));
	}
