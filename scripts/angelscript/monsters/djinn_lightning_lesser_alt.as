...
class DjinnLightningLesserAlt : CGameScript
{
	...
	DjinnLightningLesserAlt()
	{
		...
		ANIM_IDLE_DEFAULT = "idle1";
		ANIM_WARCRY = "warcry";
		ANIM_JUMPING_JACKS = "idle2";
		ANIM_BEAM = "beam";
		NPC_GIVE_EXP = 2000;
		IS_UNHOLY = 1;
		DROP_GOLD = 1;
		...
		FREQ_SHIELD = 45.0;
		FREQ_BLAST = Random(10.0, 20.0);
		DMG_BEAM = 100;
		DMG_BEAM_SECONDARY = 100;
