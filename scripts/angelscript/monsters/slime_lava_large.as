...
class SlimeLavaLarge : CGameScript
{
	string ANIM_ATTACK;
	string ANIM_DEATH;
	string ANIM_IDLE;
	...
	SlimeLavaLarge()
	{
		...
		const string ATTACK_DAMAGE = Random(55, 99);
		NPC_MUST_SEE_TARGET = 0;
		const string CHILD_SCRIPT = "test_scripts/example_scripts/monsters/slime_lava_small";
