...
class SorcShamanElder : CGameScript
{
	...
	string LELM_SUMMON_SCRIPT;
	int LHOR_SUMMON_FREQ;
	...
	SorcShamanElder()
	{
		...
		FROST_BOLT_DAMAGE = "$rand(40,75)";
		FROST_STRIKE_DAMAGE = "$rand(30,60)";
		FROST_BOLT_FREQ = 1.5;
		DEATH_SCRIPT = "monsters/summon/summon_lightning_storm";
		BALL_SIZE = 5;
		BALL_DMG = 100;
		BALL_TYPE = "lightning";
		SORC_MAX_SUMMONS = 2;
		LELM_SUMMON_SCRIPT = "monsters/elemental_air2";
		SOUND_THUNDER = "magic/bolt_end.wav";
		TORNADO_MODEL = "weapons/magic/tornado.mdl";
		SOUND_LHOR = "monsters/magic/elecidlepop.wav";
