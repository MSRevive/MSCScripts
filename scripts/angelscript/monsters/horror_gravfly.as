...
class HorrorGravfly : CGameScript
{
	...
	HorrorGravfly()
	{
		...
		BALL_DMG = 100;
		DMG_PROJECTILE = 100;
		PROJ_SCRIPT = "proj_poison_spit2";
		PROJ_SPEED = 500;
		PROJ_FOV = 0.5;
		FREQ_HORROR_BOOST = Random(5.0, 10.0);
		DOT_SHOCK = 15;
		DMG_BLAST = 100;
		ATTACK_RANGE = 60;
		ATTACK_HITRANGE = 60;
		...
		SOUND_SPRAY = "controller/con_attack3.wav";
		SOUND_FLAP1 = "monsters/bat/flap_big1.wav";
		SOUND_FLAP2 = "monsters/bat/flap_big2.wav";
		SOUND_SPRAY = "ambient/steamburst1.wav";
		SOUND_SHOCK1 = "bullchicken/bc_attack1.wav";
		SOUND_SHOCK2 = "bullchicken/bc_attack2.wav";
		SOUND_SHOCK3 = "bullchicken/bc_attack3.wav";
	}
