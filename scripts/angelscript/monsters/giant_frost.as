...
class GiantFrost : CGameScript
{
	...
	GiantFrost()
	{
		...
		const int ATK_RAD = 128;
		ATTACK_RANGE = 80;
		ATTACK_HITRANGE = 320;
		NPC_MUST_SEE_TARGET = 0;
		const int NPC_NO_VADJ = 1;
		const int DMG_SWING = 100;
		const int DMG_STOMP = 200;
	...
	void frame_melee_strike()
	{
		...
		IMPACT_POINT = "z";
		IMPACT_POINT += "z";
		XDoDamage(IMPACT_POINT, ATK_RAD, DMG_SWING, 0.1, GetOwner(), GetOwner(), "none", "blunt", "dmgevent:normswing");
	}
	...
	void frame_melee_strike2()
	{
		...
		IMPACT_POINT = "z";
		IMPACT_POINT += "z";
		XDoDamage(IMPACT_POINT, ATK_RAD, DMG_SWING, 0.1, GetOwner(), GetOwner(), "none", "blunt", "dmgevent:closeswing");
	}
	...
	void stomp_dodamage()
	{
		...
		SetVelocity(param2, /* TODO: $relvel */ $relvel(Vector3(0, NEW_YAW, 0), Vector3(0, 500, 110)));
	}
	...
	void frame_reach_attack()
	{
		...
		IMPACT_POINT = "z";
		IMPACT_POINT += "z";
		XDoDamage(IMPACT_POINT, ATK_RAD, DMG_SWING, 0.1, GetOwner(), GetOwner(), "none", "blunt", "dmgevent:reachswing");
