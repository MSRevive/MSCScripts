...
class SkeletonRavager : CGameScript
{
	...
	string ANIM_CEILING2STAND;
	string ANIM_CRAWL2STAND;
	string ANIM_DEATH;
	string ANIM_DEATH_CEILING;
	string ANIM_DEATH_CRAWL;
	string ANIM_DEATH_STAND;
	string ANIM_IDLE;
	string ANIM_IDLE_CEILING;
	string ANIM_IDLE_CRAWL;
	string ANIM_IDLE_STAND;
	string ANIM_MOVE_CEILING;
	string ANIM_MOVE_CRAWL;
	string ANIM_NPC_JUMP;
	string ANIM_PROJECTILE;
	string ANIM_PROJECTILE_CEILING;
	string ANIM_PROJECTILE_CRAWL;
	string ANIM_PROJECTILE_STAND;
	string ANIM_RUN;
	string ANIM_RUN_STAND;
	string ANIM_STAND2CEILING;
	string ANIM_STAND2CRAWL;
	string ANIM_WALK;
	string ANIM_WALK_STAND;
	string AS_ATTACKING;
	...
	string DMG_CLAW_TYPE;
	int DMG_PROJECTILE;
	float FREQ_PROJECTILE;
	float FREQ_STANCE_CHANGE;
	...
	SkeletonRavager()
	{
		...
		SKELE_SKIN = 0;
		NPC_JUMPER = 0;
		ANIM_NPC_JUMP = "attack2";
		SOUND_NPC_JUMP = "monsters/undeadz/c_skeleton_slct.wav";
		USES_PROJECTILE = 0;
		...
		ANIM_MOVE_CEILING = "anim_ceiling_move";
		ANIM_IDLE_CEILING = "anim_ceiling_idle";
		ANIM_DEATH_CEILING = "anim_death_ceiling";
		ANIM_PROJECTILE_CEILING = "anim_ceiling_projectile";
		ANIM_MOVE_CRAWL = "anim_crawl_floor";
		ANIM_IDLE_CRAWL = "anim_crawl_idle";
		ANIM_ATTACK_CRAWL = "anim_crawl_strike";
		ANIM_DEATH_CRAWL = "anim_death_floor";
		ANIM_PROJECTILE_CRAWL = "anim_crawl_strike";
		ANIM_RUN_STAND = "anim_run";
		ANIM_WALK_STAND = "walk";
		ANIM_IDLE_STAND = "idle1";
		ANIM_ATTACK_STAND = "attack1";
		ANIM_ATTACK_SLAM = "attack2";
		ANIM_DEATH_STAND = "anim_death_stand";
		ANIM_PROJECTILE_STAND = "attack2";
		ANIM_STAND2CRAWL = "anim_leapback2crawl";
		ANIM_STAND2CEILING = "anim_stand2ceiling";
		ANIM_CRAWL2STAND = "anim_crawl2stand";
		ANIM_CEILING2STAND = "anim_ceiling2floor";
		STANCE_MODE = "unset";
		FREQ_STANCE_CHANGE = Random(20.0, 40.0);
		DMG_CLAW = Random(150, 200);
		DMG_CLAW_TYPE = "slash";
		DMG_CLAW_EFFECT = "none";
		DMG_CLAW_EFFECT_DUR = 5.0;
		DMG_CLAW_EFFECT_DOT = 50;
		CLAWFX_WIDTH = 20;
		CLAWFX_COLOR = Vector3(255, 0, 0);
		CLAWFX_SPRITE = "claw.spr";
		BPAIN_USE_PAIN = 1;
		BPAIN_USE_FLINCH = 1;
		BPAIN_FREQ_FLINCH = Random(10.0, 20.0);
		BPAIN_FLINCH_HEALTH = 0.9;
		BPAIN_FLINCH_TOKENS = "flinchsmall;flinch;bigflinch;laflinch;raflinch;llflinch;rlflinch";
		SOUND_STRUCK1 = "weapons/cbar_hitbod1.wav";
		SOUND_STRUCK2 = "weapons/cbar_hitbod2.wav";
		SOUND_STRUCK3 = "weapons/cbar_hitbod3.wav";
		SOUND_PAIN1 = "monsters/undeadz/c_skeleton_hit1.wav";
		SOUND_PAIN2 = "monsters/undeadz/c_skeleton_hit2.wav";
		SOUND_ALERT1 = "monsters/undeadz/c_skeleton_bat1.wav";
		SOUND_ALERT2 = "monsters/undeadz/c_skeleton_bat2.wav";
		SOUND_ATTACK1 = "monsters/undeadz/c_skeleton_atk1.wav";
		SOUND_ATTACK2 = "monsters/undeadz/c_skeleton_atk2.wav";
		SOUND_ATTACK3 = "monsters/undeadz/c_skeleton_atk3.wav";
		SOUND_SWIPE = "zombie/claw_miss2.wav";
		SOUND_DEATH = "monsters/undeadz/c_skeleton_dead.wav";
		SOUND_LOOK = "monsters/undeadz/c_skeleton_slct.wav";
		MONSTER_MODEL = "monsters/skeleton_ravenous.mdl";
	}
