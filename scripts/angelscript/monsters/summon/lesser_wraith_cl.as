...
class LesserWraithCl : CGameScript
{
	int FX_ACTIVE;
	string MAX_RANGE;
	string MY_OWNER;
	...
	void game_prerender()
	{
		...
		ClientEffect("beam_end", MY_OWNER, 2, BEAM1_END, "lgtning.spr", 0.001, 5.0, 0.5, 255, 50, 30, Vector3(60, 60, 255));
		ClientEffect("beam_end", MY_OWNER, 3, BEAM2_END, "lgtning.spr", 0.001, 5.0, 0.5, 255, 50, 30, Vector3(60, 60, 255));
	}
