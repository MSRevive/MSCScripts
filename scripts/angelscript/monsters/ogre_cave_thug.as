...
class OgreCaveThug : CGameScript
{
	...
	OgreCaveThug()
	{
		...
		SOUND_STEP1 = "player/pl_slosh1.wav";
		SOUND_STEP2 = "player/pl_slosh2.wav";
		...
		SOUND_BEATDOWN_START = "bullchicken/bc_attackgrowl2.wav";
		SOUND_SLAM_START = "bullchicken/bc_attackgrowl3.wav";
		NPC_GIVE_EXP = 2000;
		ATTACK_HITCHANCE = 0.95;
		SWIPE_DAMAGE = RandomInt(150, 275);
		SLAM_DAMAGE = 200;
		ATTACK_RANGE = 64;
		ATTACK_HITRANGE = 80;
	}
