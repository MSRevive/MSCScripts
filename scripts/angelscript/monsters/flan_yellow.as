...
class FlanYellow : CGameScript
{
	...
	FlanYellow()
	{
		...
		const string ATTACK_DAMAGE = Random(12, 36);
	...
	void bite1()
	{
		npcatk_dodamage(HUNT_LASTTARGET, ATTACK_HITRANGE, ATTACK_DAMAGE, ATTACK_HITCHANCE, "magic");
	}
