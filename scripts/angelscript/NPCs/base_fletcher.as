...
class BaseFletcher : CGameScript
{
	...
	BaseFletcher()
	{
		const string ARROW_STACK_TYPES = "proj_arrow_bluntwooden;proj_arrow_broadhead;proj_arrow_fire;proj_arrow_frost;proj_arrow_gholy;proj_arrow_gpoison;proj_arrow_holy;proj_arrow_jagged;proj_arrow_poison;proj_arrow_silvertipped;proj_arrow_wooden;";
		const string BOLT_STACK_TYPES = "proj_bolt_fire;proj_bolt_iron;proj_bolt_silver;proj_bolt_steel;proj_bolt_wooden;";
		const string SAYTEXT_NOT_ENOUGH = "You do not have enough of that type of projectile.";
		const string SAYTEXT_BUNDLE_DONE = "There you go, all bundled up.";
		const string SAYTEXT_BUNDLE = "I can tie your arrows and bolts into neat bundles for quicker access, if you have enough to make such bundles. No charge for this.";
		const string ANIM_DONE = "pull_needle";
		const string ANIM_NO = "no";
		const string ANIM_CONVO = "converse1";
	}
