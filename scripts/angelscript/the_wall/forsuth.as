...
class Forsuth : CGameScript
{
	...
	string SOUND_BATTLE_CRY1;
	string SOUND_BATTLE_CRY2;
	string SOUND_BATTLE_CRY3;
	string SOUND_BATTLE_CRY4;
	string SOUND_BATTLE_CRY5;
	string SOUND_BYE;
	string SOUND_COME_HERE;
	string SOUND_DEATH;
	string SOUND_HEALER1;
	string SOUND_HEALER2;
	string SOUND_HI;
	string SOUND_HI_ALT;
	string SOUND_LAUGH;
	string SOUND_NO;
	...
	Forsuth()
	{
		...
		SOUND_BATTLE_CRY1 = "none";
		SOUND_BATTLE_CRY2 = "none";
		SOUND_BATTLE_CRY3 = "none";
		SOUND_BATTLE_CRY4 = "none";
		SOUND_BATTLE_CRY5 = "none";
		SOUND_VICTORY1 = "none";
		SOUND_VICTORY2 = "none";
		SOUND_PAIN1 = "none";
		SOUND_PAIN2 = "none";
		SOUND_PAIN3 = "none";
		SOUND_COME_HERE = "none";
		SOUND_HEALER1 = "none";
		SOUND_HEALER2 = "none";
		SOUND_HI = "none";
		SOUND_HI_ALT = "none";
	...
	void OnDamage(int damage) override
	{
		...
		else
		{
			...
			int RND_PAIN = RandomInt(1, MAX_HP);
			if (RND_PAIN > MAX_HP)
			{
				if (!(REQUESTED_HEALER))
				{
	...
	void give_reward()
	{
		...
		N_REWARDS_M1 -= 1;
		int REWARD_IDX = RandomInt(0, N_REWARDS_M1);
