...
class Slithar : CGameScript
{
	...
	string SOUND_PAIN1;
	string SOUND_PAIN2;
	string SOUND_PAIN_WEAK1;
	string SOUND_PAIN_WEAK2;
	string SOUND_STAFF_HIT;
	string SOUND_STAFF_MISS;
	...
	Slithar()
	{
		...
		ANIM_SUMMON = "cast_serpentstaff";
		STAFF_DAMAGE = "$rand(10,30)";
		POISON_DAMAGE = "$randf(20,30)";
		POISON_DURATION = "$randf(3,8)";
		SKELETON_SCRIPT = "monsters/skeleton_poison_random";
		SNAKE_SCRIPT = "monsters/snake_cursed";
		SOUND_ALERT = "monsters/snakeman/sm_alert2.wav";
		SOUND_ATTACK1 = "monsters/snakeman/sm_attack1.wav";
		SOUND_ATTACK2 = "monsters/snakeman/sm_attack2.wav";
		SOUND_ATTACK3 = "monsters/snakeman/sm_attack3.wav";
		SOUND_IDLE1 = "monsters/snakeman/sm_idle1.wav";
		SOUND_IDLE2 = "monsters/snakeman/sm_idle2.wav";
		SOUND_IDLE3 = "monsters/snakeman/sm_idle3.wav";
		SOUND_IDLE4 = "monsters/snakeman/sm_alert3.wav";
		SOUND_PAIN1 = "monsters/snakeman/sm_pain1.wav";
		SOUND_PAIN2 = "monsters/snakeman/sm_pain2.wav";
		SOUND_PAIN_WEAK1 = "monsters/snakeman/sm_pain3.wav";
		SOUND_PAIN_WEAK2 = "monsters/snakeman/sm_die2.wav";
		SOUND_CHANT = "monsters/snakeman/sm_summon.wav";
		SOUND_DEATH = "monsters/snakeman/sm_die1.wav";
		Precache(SOUND_DEATH);
		SOUND_SUMMON = "magic/spawn.wav";
		SOUND_STRUCK1 = "debris/flesh1.wav";
		SOUND_STRUCK2 = "debris/flesh2.wav";
		SOUND_STAFF_MISS = "zombie/claw_miss1.wav";
		SOUND_STAFF_HIT = "zombie/claw_strike1.wav";
		SUMMON_SKEL_FREQ = 90.0;
		SUMMON_SNAKE_FREQ = 7.0;
		I_AM_TURNABLE = 0;
		MONSTER_MODEL = "monsters/snakeman.mdl";
