...
class GoblinBase : CGameScript
{
	...
	GoblinBase()
	{
		...
		FREQ_CHARGE = 10.0;
		GOB_CHARGER = 1;
		GOB_CHARGE_MIN_DIST = 128;
		GOB_CHARGE_MAX_DIST = 256;
		MIN_FIREBALL_DIST = 96;
		FREQ_LEAP_AWAY = Random(5.0, 10.0);
		FREQ_GOB_JUMP = Random(3.0, 8.0);
		NEW_MODEL = 1;
		FREQ_ZDIFF_JUMP = Random(2.0, 4.0);
		GOB_MAX_ZDIFF_JUMP_RANGE = 600;
