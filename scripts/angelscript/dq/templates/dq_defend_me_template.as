...
class DqDefendMeTemplate : CGameScript
{
	...
	DqDefendMeTemplate()
	{
		QUEST_TYPE = "defend_me";
		QUEST_DATA1 = "monsters/spider_mini;monsters/spider_mini_poison";
		QUEST_DATA2 = "20;1";
		QUEST_DATA3 = "random";
		...
		QUEST_INTRO_SOUND = 0;
		QUEST_ACTIVATE_CHAT = "S-S-SPIDERS! SPIDERS EVERYWHERE!";
		QUEST_ACTIVATE_SOUND = "voices/dwarf/vs_ndwarfm1_hit1.wav";
		QUEST_FINISHED_CHAT = "T-thanks... S-so many l-legs...";
