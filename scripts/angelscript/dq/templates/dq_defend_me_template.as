...
#include "dq/quests/dq_defend_me.as"
...
class DqDefendMeTemplate : CGameScript
{
	string INIT_IDLE_MODE;

	DqDefendMeTemplate()
	{
		const string QUEST_TYPE = "defend_me";
		const string QUEST_DATA1 = "monsters/spider_mini;monsters/spider_mini_poison";
		const string QUEST_DATA2 = "20;1";
		const string QUEST_DATA3 = "random";
		...
		const string QUEST_ACTIVATE_CHAT = "S-S-SPIDERS! SPIDERS EVERYWHERE!";
		const string QUEST_ACTIVATE_SOUND = "voices/dwarf/vs_ndwarfm1_hit1.wav";
		const string QUEST_FINISHED_CHAT = "T-thanks... S-so many l-legs...";
