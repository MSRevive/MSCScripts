...
class Voldarshaman : CGameScript
{
	...
	Voldarshaman()
	{
		...
		const string SOUND_FIRECHARGE = "bullchicken/bc_attack1.wav";
		const string SOUND_FIRESHOOT = "bullchicken/bc_attack3.wav";
		const string SOUND_WARCRY1 = "monsters/orc/attack1.wav";
		const string SOUND_WARCRY2 = "monsters/orc/attack3.wav";
		const string FIRE_BALL_DAMAGE = "$rand(75,100)";
		const string BURN_DAMAGE = "$randf(10,20)";
		const float FIRE_BALL_FREQ = 2.0;
		const string DEATH_SCRIPT = "monsters/horror";
		const string NPC_DEATH_MSG = "You have slain one of Voldar's shamans";
