...
class Cavetroll : CGameScript
{
	...
	Cavetroll()
	{
		...
		const string SOUND_SPAWN = "garg/gar_alert2.wav";
		const string SOUND_FLINCH1 = "garg/gar_pain3.wav";
		const string SOUND_FLINCH2 = "garg/gar_pain2.wav";
		const string SOUND_PUSH = "garg/gar_attack3.wav";
		const string SOUND_FALL = "weapons/mortarhit.wav";
		ANIM_RUN = "walk";
		const string ANIM_FULLRUN = "run";
		ANIM_IDLE = "idle1";
		ANIM_WALK = "walk";
		ANIM_SMASH = "attack2";
		ANIM_SLASH = "attack1";
		ANIM_ATTACK = ANIM_SLASH;
		const int SLASH_RANGE = 150;
		const int SMASH_RANGE = 100;
		const int SLASH_HITRANGE = 200;
		const int SMASH_HITRANGE = 125;
		THROW_RANGE = 250;
		...
		const string MAIN_MODEL = "monsters/skeleton_hood.mdl";
		const string ALT_MODEL = "monsters/skeleton_boss2.mdl";
		Precache(ALT_MODEL);
