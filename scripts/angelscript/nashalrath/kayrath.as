...
class Kayrath : CGameScript
{
	string ANIM_ATTACK;
	string ANIM_DEATH;
	string ANIM_FIRE_HOLD;
	string ANIM_FIRE_PREP;
	string ANIM_FLINCH;
	string ANIM_IDLE;
	string ANIM_KICK;
	string ANIM_PIERCE;
	...
	int ATTACK_RANGE;
	int BONEIDX_STOMPFOOT;
	float CUSTOM_FLINCH_CHANCE;
	int CYCLES_ON;
	int DMG_SMASH;
	int DMG_STOMP;
	int DMG_SWING;
	...
	int SMASH_RANGE;
	string SOUND_DEATH;
	string SOUND_FIRE_END;
	string SOUND_FIRE_LOOP;
	string SOUND_FIRE_PREP;
	string SOUND_KICK;
	string SOUND_PAIN1;
	string SOUND_PAIN2;
	string SOUND_PAIN3;
	string SOUND_RANDRAWR1;
	string SOUND_RANDRAWR2;
	string SOUND_RANDRAWR3;
	string SOUND_RAWR;
	...
	string SOUND_SWING;
	string SOUND_WALKSTEP1;
	string SOUND_WALKSTEP2;
	string SOUND_YAWN1;
	string SOUND_YAWN2;
	string SOUND_YAWN3;
	...
	Kayrath()
	{
		...
		ANIM_STOMP = "stomp";
		ANIM_KICK = "kickcar";
		ANIM_PIERCE = "bitehead";
		ANIM_FIRE_PREP = "shootflames1";
		ANIM_FIRE_HOLD = "shootflames2";
		ANIM_RAWR = "idle2";
		ANIM_SEARCH = "idle4";
		ATTACK_RANGE = 200;
		...
		DOT_POISON = 75;
		FIRE_DURATION = 6.0;
		CUSTOM_FLINCH_CHANCE = 0.25;
		FREQ_STOMP = Random(20.0, 30.0);
		FREQ_KICK = Random(20.0, 30.0);
		FREQ_SMASH = Random(20.0, 30.0);
		FREQ_FIRE = Random(30.0, 40.0);
		FREQ_SEARCH = 20.0;
		FREQ_RANDRAWR = Random(20.0, 40.0);
		BONEIDX_STOMPFOOT = 6;
		...
		SOUND_RUNSTEP1 = "garg/gar_step1.wav";
		SOUND_RUNSTEP2 = "garg/gar_step2.wav";
		SOUND_WALKSTEP1 = "player/pl_grate1.wav";
		SOUND_WALKSTEP2 = "player/pl_grate2.wav";
		SOUND_SWING = "weapons/swinghuge.wav";
		SOUND_KICK = "weapons/swinghuge.wav";
		SOUND_STOMP = "magic/boom.wav";
		SOUND_DEATH = "garg/gar_die1.wav";
		SOUND_FIRE_PREP = "garg/gar_flameon1.wav";
		SOUND_FIRE_LOOP = "garg/gar_flamerun1.wav";
		SOUND_FIRE_END = "garg/gar_flameoff1.wav";
		SOUND_RANDRAWR1 = "garg/gar_attack1.wav";
		SOUND_RANDRAWR2 = "garg/gar_attack2.wav";
		SOUND_RANDRAWR3 = "garg/gar_attack3.wav";
		SOUND_STRUCK1 = "weapons/cbar_hitbod1.wav";
		SOUND_STRUCK2 = "weapons/cbar_hitbod2.wav";
		SOUND_STRUCK3 = "debris/bustflesh2.wav";
		SOUND_PAIN1 = "garg/gar_pain1.wav";
		SOUND_PAIN2 = "garg/gar_pain2.wav";
		SOUND_PAIN3 = "garg/gar_pain3.wav";
		SOUND_SEARCH = "garg/gar_alert1.wav";
		FIRE_CLSCRIPT = "nashalrath/kayrath_cl";
