...
class DragonGreenImg : CGameScript
{
	int AM_BREATHING;
	int AM_LIFTING;
	string ANIM_BREATH_STORM;
	string ANIM_CONVO1;
	string ANIM_CONVO2;
	string ANIM_IDLE;
	string ANIM_IDLE_LOOK;
	string ANIM_LAUGH;
	string ANIM_LAUGH_CONVO;
	string ANIM_LEAVE;
	string ANIM_LIFT_LEFT;
	string ANIM_LIFT_RIGHT;
	string ANIM_SUMMON;
	string ANIM_TALK;
	string ASPECT_ID;
	string ATK_POINTS;
	...
	string RACE_TEXT;
	string RACE_VOICE;
	string SOUND_BREATH_IN;
	string SOUND_BREATH_OUT;
	...
	DragonGreenImg()
	{
		...
		ANIM_IDLE_LOOK = "anim_img_idle2_look";
		ANIM_TALK = "anim_img_idle2_talk";
		ANIM_LEAVE = "anim_img_flyout";
		ANIM_LIFT_LEFT = "anim_img_lift_left";
		ANIM_LIFT_RIGHT = "anim_img_lift_right";
		ANIM_BREATH_STORM = "anim_img_breath_storm";
		ANIM_SUMMON = "anim_img_idle2_look";
		ANIM_LAUGH = "anim_img_idle2_talk";
		ANIM_LAUGH_CONVO = "anim_img_idle2_talk";
		ANIM_CONVO1 = "anim_img_idle2_talk";
		...
		CHAT_FACE_ON_USE = 0;
		CHAT_MENU_ENABLE = 0;
		CHAT_PLAYANIM_STYLE = "once";
		STORM_CENTER = Vector3(2496, -2608, -2024);
		STORM_RAD = 768;
		FREQ_BREATH = 120.0;
		DUR_STORM = 60.0;
		FREQ_BOLTS = Random(3.0, 7.0);
		FREQ_BALLS = Random(5.0, 10.0);
		DMG_ICE_SHARD = RandomInt(100, 200);
		DOT_COLD = 50;
		DMG_LIGHTNING_STRIKE = RandomInt(400, 800);
		DOT_LIGHTNING = 150;
		ATK_POINTS = "";
		DOT_FIRE = 100;
		DMG_METEOR = 800;
		...
		DEST_NECK_ANG = 0;
		CURRENT_NECK_ANG = 0;
		SOUND_BREATH_IN = "magic/spookie1.wav";
		SOUND_BREATH_OUT = "monsters/goblin/sps_fogfire.wav";
		Precache("weather/Storm_exclamation.wav");
		DG_BASE_RENDERAMT = 100;
	}
	...
	void do_lightning_bolt()
	{
		...
		float RND_DIST = Random(0, STORM_RAD);
