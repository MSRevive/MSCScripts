...
class DragonGreenMini : CGameScript
{
	...
	DragonGreenMini()
	{
		const string ANIMSET_ATK_CLOSE = "anim_atk_close1;anim_atk_close2;anim_atk_close2;anim_atk_close1;anim_atk_close2;anim_atk_close3;anim_atk_close1;anim_atk_close2;anim_atk_close4";
		const string ANIMSET_ATK_FAR = "anim_atk_far1";
		const string ANIM_BREATH_CLOSE = "anim_breath_close";
		const string ANIM_BREATH_FAR = "anim_breath_far";
		ANIM_ATTACK = "anim_atk_far1";
		ANIM_RUN = "anim_lx_leap";
		ANIM_WALK = "anim_lx_leap";
		ANIM_IDLE = "anim_idle_deep";
		const string ANIM_SPIT = "anim_atk_fireball";
		const string ANIM_BREATH_FAR = "anim_breath_far";
		const string ANIM_BREATH_CLOSE = "anim_breath_close";
		...
		const float NPC_BOSS_REGEN_FREQ = 120.0;
		NPC_GIVE_EXP = 20000;
		const int MAX_BREATH_RANGE = 384;
		ATTACK_MODE = "close";
		const int BONE_RIGHT_CLAW = 35;
		const int BONE_LEFT_CLAW = 30;
		const int BONE_LEFT_FOOT = 72;
		const int DMG_CLAW = 400;
		const int AOE_CLAW = 128;
		const float FALLOFF_CLAW = 0.01;
		const int DMG_BITE = 600;
		const int AOE_BITE = 96;
		const float FALLOFF_BITE = 0.01;
		const int DMG_STOMP = 800;
		const int AOE_STOMP = 256;
		const int FALLOFF_STOMP = 0;
		const string SOUND_INTRO = "monsters/dragons/c_dragnold_bat2.wav";
		const string SOUND_ALERT1 = "monsters/dragons/c_dragnold_bat1.wav";
		const string SOUND_ALERT2 = "monsters/dragons/c_dragnold_bat2.wav";
		const string SOUND_ATTACK1 = "monsters/dragons/c_dragnold_atk1.wav";
		const string SOUND_ATTACK2 = "monsters/dragons/c_dragnold_atk2.wav";
		const string SOUND_ATTACK3 = "monsters/dragons/c_dragnold_atk3.wav";
		const string SOUND_DEATH = "monsters/dragons/c_dragnold_dead.wav";
		const string SOUND_PAIN1 = "monsters/dragons/c_dragnold_hit1.wav";
		const string SOUND_PAIN2 = "monsters/dragons/c_dragnold_hit2.wav";
		const string SOUND_PAIN3 = "monsters/dragons/c_dragonold_hit2.wav";
		const string SOUND_IDLE = "monsters/dragons/c_dragnold_slct.wav";
		const string SOUND_STRUCK1 = "weapons/cbar_hitbod1.wav";
		const string SOUND_STRUCK2 = "weapons/cbar_hitbod2.wav";
		const string SOUND_STRUCK3 = "weapons/cbar_hitbod3.wav";
		const string SOUND_SWING = "weapons/swinghuge.wav";
		const string SOUND_STEP1 = "monsters/dragons/fs_x0snw_drg1.wav";
		const string SOUND_STEP2 = "monsters/dragons/fs_x0snw_drg2.wav";
		const string SOUND_STEP3 = "monsters/dragons/fs_x0snw_drg3.wav";
		const string SOUND_BREATH = "magic/spookie1.wav";
		const string SOUND_BREATH_START = "magic/flame_loop_start.wav";
		const string SOUND_BREATH_LOOP = "magic/flame_loop.wav";
		const string SOUND_FLAP = "monsters/bat/flap_big.wav";
		const string FREQ_BREATH = Random(60.0, 120.0);
		BREATH_IDX = 0;
		const float HOVER_DURATION = 15.0;
		ATK_SOUND_IDX = 0;
		const int DMG_BREATH = 75;
		const int DOT_BREATH = 100;
		const string NPC_DELAY_RETALITATE = Random(10.0, 20.0);
