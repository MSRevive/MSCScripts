...
class ElementalIceGuardian : CGameScript
{
	...
	{
		const string ICE_GUARD_NAME = "Lesser Nightmare of Ice";
		const int ICE_GUARD_HP = 1000;
		...
		const int DMG_BURST = 50;
		const int DMG_LUNGE = 100;
		const int DMG_STAFF = 50;
		const int DOT_FROST = 15;
