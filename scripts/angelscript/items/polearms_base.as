...
class PolearmsBase : CGameScript
{
	...
	string NEXT_BLOCK;
	string OWNER_YAW;
	string PANIM_BLOCK_END;
	string PANIM_BLOCK_HOLD;
	string PANIM_BLOCK_START;
	string PANIM_IDLE;
	string PANIM_POKE;
	string PANIM_POKE_BACK;
	string PANIM_REPEL;
	string PANIM_SPIN_END;
	string PANIM_SPIN_HOLD;
	string PANIM_SPIN_START;
	string PANIM_SWIPE1;
	string PANIM_SWIPE2;
	string PANIM_THROW;
	string PANIM_THROW_IDLE;
	string PANIM_THROW_PREP;
	string PANIM_THROW_PREPED_THROW;
	float POLE_BACKHAND_ACCURACY;
	float POLE_BACKHAND_ATK_DURATION;
	int POLE_BACKHAND_ATTACK;
	int POLE_BACKHAND_DMG;
	float POLE_BACKHAND_DMG_DELAY;
	...
	string SOUND_READY;
	string SOUND_SHOUT;
	string SOUND_SPIN_LOOP;
	string SOUND_SWIPE;
	string SOUND_THROW;
	string SOUND_THRUST;
	int VANIM_BLOCK_END;
	int VANIM_BLOCK_HOLD;
	int VANIM_BLOCK_START;
	int VANIM_DRAW;
	int VANIM_IDLE1;
	int VANIM_IDLE2;
	int VANIM_IDLE3;
	...
	int VANIM_SPIN_END;
	int VANIM_SPIN_HOLD;
	int VANIM_SPIN_START;
	int VANIM_SWIPE1;
	int VANIM_SWIPE2;
	int VANIM_THROW_IDLE;
	int VANIM_THROW_POWER;
	int VANIM_THROW_PREP;
	int VANIM_THROW_PREPED_THROW;
	int VANIM_WIDE;
	string VMODEL_FILE;
	string WANIM_FLOOR;
	string WANIM_HAND;
	...
	PolearmsBase()
	{
		...
		VANIM_SPIN_END = 12;
		VANIM_REPEL = 13;
		VANIM_BLOCK_START = 14;
		VANIM_BLOCK_HOLD = 15;
		VANIM_BLOCK_END = 16;
		VANIM_THROW_POWER = 17;
		VANIM_THROW_PREP = 18;
		VANIM_THROW_PREPED_THROW = 19;
		VANIM_THROW_IDLE = 20;
		WANIM_FLOOR = "standard_floor_idle";
		WANIM_HAND = "standard_idle";
		PANIM_IDLE = "aim_pole";
		PANIM_POKE = "pole_swing";
		PANIM_POKE_BACK = "Pattack2";
		PANIM_SWIPE1 = "Pattack2";
		PANIM_SWIPE2 = "Pattack3";
		PANIM_SPIN_START = "Spin_start";
		PANIM_SPIN_HOLD = "Spin";
		PANIM_SPIN_END = "Spin_end";
		PANIM_REPEL = "repel";
		PANIM_BLOCK_START = "block_start";
		PANIM_BLOCK_HOLD = "block";
		PANIM_BLOCK_END = "block_end";
		PANIM_THROW = "throw1";
		PANIM_THROW_PREP = "throw2_start";
		PANIM_THROW_IDLE = "throw2_aim";
		PANIM_THROW_PREPED_THROW = "throw2_end";
		...
		SOUND_BACKHAND = "weapons/swingsmall.wav";
		SOUND_BLOCK = "body/armour1.wav";
		SOUND_READY = GetEntityProperty(GetOwner(), "scriptvar");
		SOUND_CHARGE = GetEntityProperty(GetOwner(), "scriptvar");
		SOUND_SHOUT = GetEntityProperty(GetOwner(), "scriptvar");
		SOUND_SPIN_LOOP = "weapons/polearm_spin.wav";
		...
		POLE_CAN_BACKHAND = 1;
		POLE_CAN_THROW = 0;
		POLE_CAN_POWER_THROW = 0;
		POLE_BLOCK_PROT_RATIO = 0.3;
		POLE_BLOCK_DELAY = 3.0;
		POLE_REPEL_STRENGTH = 600;
		POLE_SWIPE_DMG = 60;
		POLE_SWIPE_DMG_RANGE = 20;
		POLE_SWIPE_DMG_TYPE = "blunt";
		POLE_SWIPE_RANGE = 60;
		POLE_SWIPE_ACCURACY = 0.6;
		POLE_SWIPE_DMG_DELAY = 0.5;
		POLE_SWIPE_ATK_DURATION = 0.9;
		...
		POLE_BACKHAND_DMG_DELAY = 0.8;
		POLE_BACKHAND_ATK_DURATION = 1.2;
		POLE_BACKHAND_STUN = 0;
		POLE_BACKHAND_STUN_CHANCE = 0.0;
		POLE_BACKHAND_REPEL = 0;
		POLE_THROW_PREPED_ATKDELAY = 0.1;
		POLE_THROW_PREP_DELAY = 0.3;
	...
	void pole_do_throw2()
	{
		...
		float CHARGE_RATIO = GetGameTime();
