...
class ManaRegen : CGameScript
{
	...
	void drink_spawn()
	{
		SetName("Regeneration Potion");
		SetDescription("Provides continuous health regeneration , for a time.");
		SetWeight(1);
		SetSize(1);
		SetValue(1000);
	...
	void game_drink()
	{
		CallExternal(GetEntityIndex(GetOwner()), "potion_regen", 500.0);
		drink_now();
	}
