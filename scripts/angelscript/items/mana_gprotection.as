...
class ManaGprotection : CGameScript
{
	int DRINK_AMOUNT;
	int DRINK_EFFECTAMT;
	...
	void drink_spawn()
	{
		SetName("Greater Protection Potion");
		SetDescription("Grants 60% damage reduction , for a lengthy time.");
		SetWeight(1);
		SetSize(1);
		SetValue(1000);
	...
	void game_drink()
	{
		ApplyEffect(GetOwner(), "effects/protection", 5400, 0.4);
		drink_now();
	}
