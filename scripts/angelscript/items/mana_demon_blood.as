...
class ManaDemonBlood : CGameScript
{
	int ANIM_DRINK;
	int ANIM_IDLE;
	string ANIM_PREFIX;
	...
	void drink_spawn()
	{
		SetName("Vial of Demon Blood");
		SetDescription("Infuses you with the soul of a demon for a time, but at a price.");
		SetWeight(1);
		SetSize(1);
		SetValue(1000);
	...
	void game_drink()
	{
		ApplyEffect(GetEntityIndex(GetOwner()), "effects/demon_blood", 60.0, -5);
		// TODO: hud.addstatusicon ent_owner hud/status/status_demon demon_blood 60.0
		drink_now();
	}
