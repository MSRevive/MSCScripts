...
class ManaProtection : CGameScript
{
	int DRINK_AMOUNT;
	int DRINK_EFFECTAMT;
	...
	void drink_spawn()
	{
		SetName("Protection Potion");
		SetDescription("Grants 25% damage reduction , for a time.");
		SetWeight(1);
		SetSize(1);
		SetValue(200);
	...
	void game_drink()
	{
		ApplyEffect(GetOwner(), "effects/protection", 5400, 0.75);
		drink_now();
	}
