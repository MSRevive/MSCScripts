...
class SwordsUb : CGameScript
{
	...
	SwordsUb()
	{
		SOUND_MODE_SWITCH = "magic/energy1_loud.wav";
		HP_RETURN_RATIO = 0.02;
		DARK_SHIELD_MP = 50;
		DARK_SHIELD_DURATION = 40.0;
		RANGED_MP = 30;
		RANGED_ATK_DURATION = 0.3;
		RANGED_AIMANGLE = Vector3(0, 0, 0);
		RANGED_STARTPOS = Vector3(4, 0, -3);
		BASE_LEVEL_REQ = 30;
		ANIM_LIFT = 0;
		ANIM_IDLE1 = 1;
		ANIM_ATTACK1 = 2;
		...
		SOUND_DEPLOY = "magic/chant_loop.wav";
		SOUND_BLOCK = "weapons/axemetal1.wav";
