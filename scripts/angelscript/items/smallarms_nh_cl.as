...
class SmallarmsNhCl : CGameScript
{
	string HIT_TYPE;
	string IMPACT_POINT;
	string MY_OWNER;
	...
	{
		ClientEffect("tempent", "model", "weapons/projectiles.mdl", ORIGIN_POINT, "setup_knife");
	}
	...
	void vanish_fx()
	{
		if (HIT_TYPE == "world")
		{
			...
			EmitSound3D("debris/glass1.wav", 5, IMPACT_POINT);
		}
		if (SPRITE_SCALE == 2.0)
		{
			EmitSound3D("weapons/explode3.wav", 5, IMPACT_POINT);
		}
