...
:: copy scripts.pak to C:\Program Files (x86)\Steam\steamapps\common\msrebirth\msr and overwrite the existing file
copy scripts.pak "C:\Program Files (x86)\Steam\steamapps\common\msrebirth\msr\scripts.pak" /Y